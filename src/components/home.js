    ...
    return (
        <section id="home" className={ home }>
            <div className={ homeContent }>
                <div>
                    <h2 id="htr1">I am</h2>
                    <h1 id="htr2">an IT student</h1>
                </div>

                <div>
                    <h2 id="htr3">I am specialized in</h2>
                    <h1 id="htr4">a Web Development</h1>
                </div>

                <div>
                    <h2 id="htr5">and</h2>
                    <h1 id="htr6">Desktop Applications Development</h1>
                </div>
                ...
                <div>
                    <a href="#what" title="Check my projects" id="scroll-what">
